...
(here: the VS Code Templates tree view).
...
project-level templates. Built-in items SHALL offer a "Customize" action.
Any item SHALL offer an "Insert into…" action that prompts for a
