...
| --- | ---: | --- |
| `@openspec-ui/core` | 0.18.1 | Shared behavior and persistence contract |
| `openspec-ui-vscode` | 0.12.0 | VS Code delivery |
| `@openspec-ui/server` | 1.7.1 | Standalone server delivery |
