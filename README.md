...
| --- | ---: | --- |
| `@openspec-ui/core` | 0.18.0 | Shared behavior and persistence contract |
| `openspec-ui-vscode` | 0.12.2 | VS Code delivery |
| `@openspec-ui/server` | 1.7.0 | Standalone server delivery |
