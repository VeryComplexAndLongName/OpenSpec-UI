...
describe("tabReadings", () => {
  ...
  it.each<[string, Partial<ShellReadingState>, string, string]>([
    ...
    ["a comparison", { comparisonLoading: true, comparisonCount: 3 }, "timeline", "Reading the history of 3 changes from git…"],
    ["a comparison of one", { comparisonLoading: true, comparisonCount: 1 }, "timeline", "Reading the history of 1 change from git…"],
