...
- Browse built-in and project-level change templates in the Templates
  ...
  and are never deletable through the UI. 17 built-in templates across 10
  ...
  release-management), covering Python, Node.js/TypeScript, ASP.NET Core,
  and language-agnostic patterns.
