...
summary: GitHub, GitLab or Gitea now sit behind one Forge interface. What that took, and the quirks live testing found on each of the three.
cover: cover.jpg
cover_alt: The OpenSpec Workbench owl, thoughtful, beside the words One interface, three forges
---
...
![Your repository's origin decides which forge answers: GitHub, GitLab or another host probed for Gitea, all behind one Forge interface](one-interface-three-forges/diagram.png)
