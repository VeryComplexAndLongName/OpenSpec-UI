...
published: false
description: A 54 MB leftover that survived a whole day of cleanup passes, and a context window nobody was reading until DeepSeek's own agent told us how full it was.
tags: openspec, devtools, deepseek, opensource
cover_image: https://raw.githubusercontent.com/VeryComplexAndLongName/OpenSpec-UI/main/docs/articles/site/two-things-nobody-was-watching/cover.jpg
canonical_url: https://openspec-ui.dev/articles/two-things-nobody-was-watching/
---

*First published on [openspec-ui.dev](https://openspec-ui.dev/articles/two-things-nobody-was-watching/).*
