...
published: false
description: Adding DeepSeek as a tenth agent touched one file in the core. The finding worth reading is what dsh does on the wrong Node.
tags: openspec, ai, deepseek, typescript
cover_image: https://raw.githubusercontent.com/VeryComplexAndLongName/OpenSpec-UI/main/docs/articles/site/a-new-agent-and-nothing-else-moved/cover.jpg
canonical_url: https://openspec-ui.dev/articles/a-new-agent-and-nothing-else-moved/
---

*First published on [openspec-ui.dev](https://openspec-ui.dev/articles/a-new-agent-and-nothing-else-moved/).*
...
![One new file joins the registry of ten agents; the core is the only place that changed; the server and the extension are not touched](https://raw.githubusercontent.com/VeryComplexAndLongName/OpenSpec-UI/main/docs/articles/site/a-new-agent-and-nothing-else-moved/diagram.png)
