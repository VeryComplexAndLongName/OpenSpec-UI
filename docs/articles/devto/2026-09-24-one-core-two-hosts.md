...
published: false
description: How a VS Code extension and a local web app are kept from drifting apart: one core, thin hosts, and where thin was not free.
tags: openspec, architecture, vscode, typescript
cover_image: https://raw.githubusercontent.com/VeryComplexAndLongName/OpenSpec-UI/main/docs/articles/site/one-core-two-hosts/cover.jpg
canonical_url: https://openspec-ui.dev/articles/one-core-two-hosts/
---

*First published on [openspec-ui.dev](https://openspec-ui.dev/articles/one-core-two-hosts/).*
...
![The shared core with the server, the extension and the command line as adapters around it, and the shared UI between the two hosts](https://raw.githubusercontent.com/VeryComplexAndLongName/OpenSpec-UI/main/docs/articles/site/one-core-two-hosts/architecture.png)
