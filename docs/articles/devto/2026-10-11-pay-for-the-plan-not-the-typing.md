...
published: false
description: A chain has four stages you can hand to four different agents, at four different prices. The harness can prove the savings on two of the three agents involved, and is honestly blind to the third.
tags: openspec, ai, deepseek, opensource
cover_image: https://raw.githubusercontent.com/VeryComplexAndLongName/OpenSpec-UI/main/docs/articles/site/pay-for-the-plan-not-the-typing/cover.png
canonical_url: https://openspec-ui.dev/articles/pay-for-the-plan-not-the-typing/
---

*First published on [openspec-ui.dev](https://openspec-ui.dev/articles/pay-for-the-plan-not-the-typing/).*
...
![One chain, four stages, three agents, three ways of reporting what they spent - two convert to money you can cap, one reports nothing at all](https://raw.githubusercontent.com/VeryComplexAndLongName/OpenSpec-UI/main/docs/articles/site/pay-for-the-plan-not-the-typing/diagram.png)
